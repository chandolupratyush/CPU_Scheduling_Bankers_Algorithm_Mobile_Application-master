...
public class Lrtf extends AppCompatActivity {
    int count = 0;
    int a[] = new int[10];
    int b[] = new int[10];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lrtf);
        TextView myText = (TextView) findViewById(R.id.textview1lrtf);
